...
cursor.execute('CREATE TABLE pedido(id_pedido INT AUTO_INCREMENT PRIMARY KEY,data DATE NOT NULL,horarioinicio VARCHAR(20) NOT NULL,id_clientes INT NOT NULL, id_empresa INT NOT NULL,FOREIGN KEY(id_clientes) REFERENCES clientes(id_clientes),FOREIGN KEY(id_empresa) REFERENCES empresa(id_empresa))')
