...
def init():
    ...
    cursor.execute('CREATE TABLE datacliente(id INT AUTO_INCREMENT PRIMARY KEY,FOREIGN KEY(id) REFERENCES clientes(id),FOREIGN KEY(nome) REFERENCES servicos(nome), data DATE NOT NULL, horarioinicio TIME NOT NULL)')
    cursor.execute('CREATE TABLE dataempresa(id INT AUTO_INCREMENT PRIMARY KEY,FOREIGN KEY(id) REFERENCES empresa(id),FOREIGN KEY(nome) REFERENCES clientes(nome), data DATE NOT NULL, horarioinicio TIME NOT NULL, horariofim TIME NOT NULL)')
